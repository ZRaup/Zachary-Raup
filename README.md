...
&nbsp;  
## [Project 1: Utilizing MCMC in Python to Explore the Parameter Space of an Exoplanet Transit](TOI4153_por.md)
...
###### Skills Applied: Python (pandas, matplotlib, numpy, emcee, & batman) & Excel  
